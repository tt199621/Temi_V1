...
// * 展厅介绍--配置
// */
//public class ExhibitionActivitybackup extends BaseActivity implements ExhibitionListAdapter.OnItemClickListener{
...
//        mOrderAdapter = new ExhibitionListAdapter(R.layout.exhibition_list_item);
//        mOrderAdapter.setOnItemClickListener(ExhibitionActivitybackup.this);
...
//            Intent intent = new Intent(ExhibitionActivitybackup.this, ExhibitionDestilsActivity.class);
