...
// * 展厅介绍详情页==循环
// */
//public class BoothDetailsActivity3 extends BaseActivity implements OnGoToLocationStatusChangedListener {
...
//                            finish();//每说完话结束当前页面
//                        } else {
//                            Constant.goAddre = "unshunxu";
////                        robot.goTo("迎宾点");
//                            //延迟执行
////                        getIntent().removeExtra(Constant.bolAddress);//清除数据
////                        Constant.addressindex = 1;//下标复原
//                            Constant.address = Constant.alladdress[dempindex-2];//获取地址赋值给临时地址
//                            Constant.alladdressKey = true;//是全局导览
//                            Intent intent = new Intent();
//                            intent.setAction(BroadcastListener.ACTION);
//                            intent.putExtra(Constant.clicks, 2000);
