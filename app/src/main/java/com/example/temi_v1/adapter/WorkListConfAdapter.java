...
public class WorkListConfAdapter extends BaseQuickAdapter<AlarmItem, BaseViewHolder> {
    public WorkListConfAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, AlarmItem item) {
